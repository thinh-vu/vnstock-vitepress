...
const _sfc_main$y = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      var _a, _b;
      const data = await import("./virtual_search-data.Dx5L9Syd.js");
