...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><iframe src="https://thinh-vu-vnstock.hf.space" frameborder="0" width="100%" height="900" style="${ssrRenderStyle({ "min-width": "1500px" })}"></iframe></div>`);
}
